...
@Entity
@Table(name = "normaisabaixados")
public class NormaisAbaixados {
	...
	public NormaisAbaixados(Long id, String aPerto, String bPerto, String cPerto, String dPerto, Personagem personagem,
			List<Frames> frames) {
		super();
		this.id = id;
		this.aPerto = aPerto;
